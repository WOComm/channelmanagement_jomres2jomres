...
* @package Jomres\CMF
*
* Handles booking_added webhook events on the parent server and imports a booking into the local installation
*
*
*/
    ...
    function __construct($componetArgs)
	{
		...
		if ( isset($item->data->property_uid) && isset($item->data->contract_uid)) {
			...
			if (is_array($response) ) {
				...
				//$response = $channelmanagement_framework_singleton->rest_api_communicate("jomres2jomres", 'PUT', $endpoint, $data_array);
